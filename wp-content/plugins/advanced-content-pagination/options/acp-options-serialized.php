...
class ACPOptionsSerialized {

    public $acp_option_slug = 'acp_options';
    // GENERAL SETTINGS
    ...
    public $acp_arrows_bg;
    public $acp_arrows_hover_bg;
    public $acp_arrows_color;
    public $acp_arrows_hover_color;
     ...
     * Phrases
     */
    public $acpPhrasePrevious;
    public $acpPhraseNext;
    ...
    public function initOptions($serialize_options) {
        ...
        $this->acpPhrasePrevious = isset($options['acpPhrasePrevious']) && ($phrasePrev = trim($options['acpPhrasePrevious'])) ? $phrasePrev : __('Previous', 'advanced-content-pagination');
        $this->acpPhraseNext = isset($options['acpPhraseNext']) && ($phraseNext = trim($options['acpPhraseNext'])) ? $phraseNext : __('Next', 'advanced-content-pagination');
        ...
        $this->acp_arrows_bg = isset($options['acp_arrows_bg']) ? $options['acp_arrows_bg'] : '#333333';
        $this->acp_arrows_hover_bg = isset($options['acp_arrows_hover_bg']) ? $options['acp_arrows_hover_bg'] : '#000000';
        $this->acp_arrows_color = isset($options['acp_arrows_color']) ? $options['acp_arrows_color'] : '#ffffff';
        $this->acp_arrows_hover_color = isset($options['acp_arrows_hover_color']) ? $options['acp_arrows_hover_color'] : '#ffffff';
    }
    ...
    public function toArray() {
        $options = array(
            ...
            'acpPhrasePrevious' => $this->acpPhrasePrevious,
            'acpPhraseNext' => $this->acpPhraseNext,
            ...
            'acp_arrows_bg' => $this->acp_arrows_bg,
            'acp_arrows_hover_bg' => $this->acp_arrows_hover_bg,
            'acp_arrows_color' => $this->acp_arrows_color,
            'acp_arrows_hover_color' => $this->acp_arrows_hover_color
        );
    ...
    public function addOptions() {
        $options = array(
            ...
            'acpPhrasePrevious' => __('Previous', 'advanced-content-pagination'), // pagination buttons visual style
            'acpPhraseNext' => __('Next', 'advanced-content-pagination'), // pagination buttons visual style
            ...
            'acp_arrows_bg' => '#333333',
            'acp_arrows_hover_bg' => '#000000',
            'acp_arrows_color' => '#ffffff',
            'acp_arrows_hover_color' => '#ffffff',
        );
